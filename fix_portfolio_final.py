...
# Using regex to replace the entire <div className="custom-asymmetric-collage"> ... </style> block
content = re.sub(r'<div className="custom-asymmetric-collage">.*?</style>\s*\}\}\s*\/>', new_collage, content, flags=re.DOTALL)

with open(filepath, 'w', encoding='utf-8') as f:
    f.write(content)

print("Collage fixed perfectly.")
