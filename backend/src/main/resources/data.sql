...
INSERT IGNORE INTO service_offerings (id, name, category, description, icon, display_order, is_active) VALUES
...
(5, 'Botanical Reception', 'An outdoor reception transformed into an enchanted garden with custom iron archways, hanging floral installations, and ambient lighting design creating a seamless indoor-outdoor flow.', 'WEDDING', '/images/portfolio/botanical-reception.jpg', 'Custom Iron Archways | 1500+ Stem Count | Ambient Lighting | Indoor-Outdoor Flow', 'The Deshmukh Family', 'Pune, Maharashtra', '2026-01', false, 5),
(6, 'Brand Activation Suite', 'An immersive brand activation for a luxury automobile launch — custom-fabricated display structures, interactive LED walls, and experiential zones designed to showcase the vehicle in a curated environment.', 'CORPORATE', '/images/portfolio/brand-activation.jpg', 'Custom Fabrication | Interactive LED | 3 Experience Zones | 200+ VIP Guests', 'AutoLux India', 'Mumbai, Maharashtra', '2026-04', false, 6);

-- Testimonials
INSERT IGNORE INTO testimonials (id, client_name, role, quote, rating, category, is_active, display_order) VALUES
...
INSERT IGNORE INTO team_members (id, name, role, bio, display_order, is_active) VALUES
...
INSERT IGNORE INTO event_packages (id, name, tier, scope, price_range, category, features, is_popular, display_order) VALUES
